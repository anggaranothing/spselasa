 ...
 */
public class FrameDiagnosticHistory extends javax.swing.JInternalFrame {
    ...
    private void loadRecord() {
        ...
        try {
            modelRecord = objectDao.readByUser( Main.userSession.getUser() );
            updateMaxPage();
    ...
    private void fillToTable( boolean isEditData, Diagnostic dgn, DefaultTableModel tableModel ) {
        if ( !isEditData ) { // data baru
            ...
            if( row > -1 ) {
                ...
                tableModel.setValueAt( dgn.getStatus().name(),  row, 2);
            }
        }
    }
    ...
    private void doFindKeyword( String keyword , boolean isPrevious ) {
        ...
        new Thread(new Runnable(){ public void run(){
            ...
            while( whileCondition ) {
                ...
                if( dgn.getDate().toString().toLowerCase().contains( keyword.toLowerCase() ) ) {
                    isFound = true;
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnDetail, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void btnDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailActionPerformed
        // TODO add your handling code here:
        try {
            Map<Disease,Float> temp = objectDao.getResult( modelRecord.get( getRecordIndexOnTable() ) );

            Helper.attachToDesktop( (javax.swing.JDesktopPane) this.getParent(), new FrameDiagnosticResult( temp ), true );
        } catch (RemoteException ex) {
        }
