 ...
 */
public class FrameDisease extends javax.swing.JInternalFrame {

    private List<Disease>       modelRecord     = new ArrayList<Disease>();
    private IfDiseaseDao        objectDao       = null;
    ...
    private void initDao() {  
        String url = String.format( "rmi://%s:%d/%s" , ClientConfig.getRmiHost() , ClientConfig.getRmiPort() , ClientConfig.RMI_DISEASE_NAME );
        jBusyLabel.setVisible( true );
        try {
            
            // ambil referensi dari remote object yg ada di server
            objectDao = ( IfDiseaseDao ) Naming.lookup(url);
            
        } catch (NotBoundException ex) {
            Helper.logThrowable( "FrameDisease initDao() failed!", ex );
    ...
    private void loadRecord() {
        ...
        try {
            ...
            Helper.logThrowable( "FrameDisease loadRecord() failed!", ex );
        }
    ...
    private void fillToTable( boolean isEditData, Disease dss , DefaultTableModel tableModel ) {
        if ( !isEditData ) { // data baru
            Object[] objects = new Object[ tableModel.getColumnCount() ];

            objects[0] = dss.getId();
            objects[1] = dss.getName();
            objects[2] = dss.getDescription();
            objects[3] = dss.getPicture();
            objects[4] = dss.getLastUpdate();
            ...
            if( row > -1 ) {
                ...
                tableModel.setValueAt( dss.getId(),             row, 0);
                tableModel.setValueAt( dss.getName(),           row, 1);    
                tableModel.setValueAt( dss.getDescription(),    row, 2);
                tableModel.setValueAt( dss.getPicture(),        row, 3);
                tableModel.setValueAt(  dss.getLastUpdate(),    row, 4);
            }
        }
    }
    ...
    private void doFindKeyword( String keyword , boolean isPrevious ) {
        ...
        new Thread(new Runnable(){ public void run(){
            ...
            boolean isId               = keyword.toLowerCase().startsWith( "d" ) && Character.isDigit( keyword.charAt(1) );
            ...
            while( whileCondition ) {
                ...
                Disease dss = (Disease) modelRecord.get( lastFindIndex );
                
                // find by Description
                if( !isId ) {
                    if( dss.getDescription().toLowerCase().contains( keyword.toLowerCase() ) ) {
                        isFound = true;
                ...
                // find by ID
                    ...
                    if( dss.getId().toLowerCase().contains( keyword.toLowerCase() ) ) {
                        isFound = true;
                        isOkayToChangePage = true;
                    }
                }
    ...
    private void doAddEditRecord() {
        ...
        Disease dsObj = new Disease();
        dsObj.setId(          "D" + tfDlgId.getText() );
        dsObj.setName(        Helper.nullifyEmpty( tfDlgName.getText() ) );
        dsObj.setPicture(     Helper.nullifyEmpty( tfDlgPicture.getText() ) );
        dsObj.setDescription( Helper.nullifyEmpty( epDlgDesc.getText() ) );
        dsObj.setPrevention(  Helper.nullifyEmpty( epDlgPrev.getText() ) );
        dsObj.setTreatment(   Helper.nullifyEmpty( epDlgTreat.getText() ) );
        dsObj.setLastUpdate(  Helper.getCurrentSystemTimestamp() );
        
        try {
            if( !isEditRecord )
                objectDao.create(dsObj);
            else
                objectDao.update(dsObj);
    ...
    private void doDeleteRecord() {
        ...
        dssObj.setId( modelRecord.get( getRecordIndexOnTable() ).getId() );
        
        try {
            objectDao.delete( dssObj );
    ...
    private void initComponents() {
        ...
        epDlgPrev = new javax.swing.JEditorPane();
        jLabel14 = new javax.swing.JLabel();
        jScrollPane6 = new javax.swing.JScrollPane();
        epDlgTreat = new javax.swing.JEditorPane();
        jLabel15 = new javax.swing.JLabel();
        tfDlgPicture = new javax.swing.JTextField();
        ...
        dialogAddEdit.setMinimumSize(new java.awt.Dimension(360, 708));
        dialogAddEdit.setModal(true);
        dialogAddEdit.setResizable(false);
        dialogAddEdit.setSize(new java.awt.Dimension(360, 708));
        ...
        tfDlgName.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tfDlgName.setText("jTextField2");

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel13.setText("Prevention");

        jScrollPane5.setViewportView(epDlgPrev);

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel14.setText("Treatment");

        jScrollPane6.setViewportView(epDlgTreat);

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel15.setText("Picture");

        tfDlgPicture.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tfDlgPicture.setText("jTextField3");
        ...
        dialogAddEditLayout.setVerticalGroup(
            ...
            .addGroup(dialogAddEditLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfDlgPicture, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15))
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel11)
        ...
        tblRecord.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Description", "Picture", "Last Update"
            }
        ) {
    ...
    private void dialogAddEditComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_dialogAddEditComponentShown
        // TODO add your handling code here:
        String dlgTitle = "Add New Record", dlgId,dlgNama,dlgDesc,dlgPict,dlgPrev,dlgTreat;
               dlgId = dlgNama = dlgDesc = dlgPict = dlgPrev = dlgTreat = "";
        ...
        if( getRecordIndexOnTable() >= 0 ) {
            ...
            if( isEditRecord ) {
                ...
                dlgDesc  = modelRecord.get( getRecordIndexOnTable() ).getDescription();
                dlgPict  = modelRecord.get( getRecordIndexOnTable() ).getPicture();
                dlgPrev  = modelRecord.get( getRecordIndexOnTable() ).getPrevention();
                dlgTreat = modelRecord.get( getRecordIndexOnTable() ).getTreatment();
            }
        }
        dialogAddEdit.setTitle( dlgTitle );
        tfDlgId.setText(      dlgId );
        tfDlgName.setText(    dlgNama );
        tfDlgPicture.setText( dlgPict );
        epDlgDesc.setText(    dlgDesc );
        epDlgPrev.setText(    dlgPrev );
        epDlgTreat.setText(   dlgTreat );
    ...
    private void btnDlgConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDlgConfirmActionPerformed
        // name is empty?
        if( Helper.nullifyEmpty( tfDlgName.getText() ) == null ) {
            JOptionPane.showMessageDialog( this,
                 "Name is empty",
                null, JOptionPane.WARNING_MESSAGE );
    ...
    private javax.swing.JEditorPane epDlgPrev;
    private javax.swing.JEditorPane epDlgTreat;
    ...
    private javax.swing.JTextField tfDlgPicture;
