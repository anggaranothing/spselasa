...
public class FrameUser extends javax.swing.JInternalFrame {
    ...
    private List<User>          modelRecord     = new ArrayList<User>();
    private List<Group>         groupRecord     = new ArrayList<Group>();
    private IfUserDao           objectDao       = null;
    private IfGroupDao          groupDao        = null;
    private final Map<Integer,String> grpNameMap = new HashMap<Integer,String>();
    ...
    private void initDao() {  
        String url = String.format( "rmi://%s:%d/%s" , ClientConfig.getRmiHost() , ClientConfig.getRmiPort() , ClientConfig.RMI_USER_NAME );
        jBusyLabel.setVisible( true );
        try {
            
            // ambil referensi dari remote object yg ada di server
            objectDao = ( IfUserDao ) Naming.lookup(url);
            
            url = String.format( "rmi://%s:%d/%s" , ClientConfig.getRmiHost() , ClientConfig.getRmiPort() , ClientConfig.RMI_GROUP_NAME );
            groupDao  = ( IfGroupDao ) Naming.lookup(url);
            
        } catch (NotBoundException ex) {
            Helper.logThrowable( "FrameUser initDao() failed!", ex );
    ...
    private void loadRecord() {
        ...
        try {
            ...
            groupRecord = groupDao.read();
            updateMaxPage();
            findIter = modelRecord.listIterator();
            for( Group grup : groupRecord ) {
                grpNameMap.put( grup.getId(), grup.getName() );
            }
            btnAdd.setEnabled( true );
        } catch (RemoteException ex) {
            Helper.ShowDialogAndLogThrowable( this, "FAILED to read record from the server !", ex );
        } catch(java.lang.NullPointerException ex) {
            Helper.logThrowable( "FrameUser loadRecord() failed!", ex );
        }
    ...
    private void fillToTable( boolean isEditData, User user , DefaultTableModel tableModel ) {
        if ( !isEditData ) { // data baru
            ...
            objects[3] = ( user.isFemale() ? "Female" : "Male" );
            objects[4] = grpNameMap.get( user.getGrup() );
            objects[5] = user.getRegister();
            objects[6] = user.getLastlogin();
            ...
            if( row > -1 ) {
                ...
                tableModel.setValueAt( user.getId(),                            row, 0);
                tableModel.setValueAt( user.getEmail(),                         row, 1);
                tableModel.setValueAt( user.getName(),                          row, 2);
                tableModel.setValueAt( ( user.isFemale() ? "Female" : "Male" ), row, 3);
                tableModel.setValueAt( user.getGrup()                         , row, 4);
                tableModel.setValueAt( user.getRegister()                     , row, 5);
                tableModel.setValueAt( user.getLastlogin()                    , row, 6);
            }
        }
    }
    ...
    private void doFindKeyword( String keyword , boolean isPrevious ) {
        ...
        new Thread(new Runnable(){ public void run(){
            ...
            boolean isEmail = Helper.isValidEmailAddress( keyword.trim() );
            ...
            while( whileCondition ) {
                ...
                User user = (User) modelRecord.get(lastFindIndex );
                
                if( isEmail ) {
                    if( user.getEmail().toLowerCase().equals( keyword.toLowerCase().trim() ) ) {
                        isFound = true;
    ...
    private void doAddEditRecord() {
        ...
        userObj.setId(    Long.valueOf( tfDlgId.getText() ) );
        userObj.setName(  Helper.nullifyEmpty( tfDlgNama.getText() ) );
        userObj.setEmail( Helper.nullifyEmpty( tfDlgEmail.getText().trim() ) );
        userObj.setFemale( radDlgFemale.isSelected() );
        
        String pass = Helper.nullifyEmpty( String.valueOf( pfDlgPassword.getPassword() ) );
        if( isEditRecord && pass == null )
            pass = modelRecord.get( getRecordIndexOnTable() ).getPass();
        userObj.setPass( pass );
        userObj.setGrup( groupRecord.get( cmbDlgGroup.getSelectedIndex() ).getId() );
        userObj.setRegister( Helper.getCurrentSystemTimestamp() );
        
        try {
            if( !isEditRecord )
                objectDao.create(userObj);
            else
                objectDao.update(userObj);
    ...
    private void doDeleteRecord() {
        ...
        User userObj = new User();
        userObj.setId( modelRecord.get( getRecordIndexOnTable() ).getId() );
        
        try {
            objectDao.delete( userObj );
    ...
    private void initComponents() {
        ...
        tfDlgEmail = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        jLabel14 = new javax.swing.JLabel();
        pfDlgPassword = new javax.swing.JPasswordField();
        pfDlgRetype = new javax.swing.JPasswordField();
        btnDlgCancel = new javax.swing.JButton();
        jSeparator1 = new javax.swing.JSeparator();
        btnDlgConfirm = new javax.swing.JButton();
        jLabel15 = new javax.swing.JLabel();
        radDlgMale = new javax.swing.JRadioButton();
        radDlgFemale = new javax.swing.JRadioButton();
        jLabel16 = new javax.swing.JLabel();
        cmbDlgGroup = new javax.swing.JComboBox<>();
        jLabel11 = new javax.swing.JLabel();
        tfDlgNama = new javax.swing.JTextField();
        grpDlgGender = new javax.swing.ButtonGroup();
        ...
        dialogAddEdit.setMinimumSize(new java.awt.Dimension(360, 425));
        dialogAddEdit.setModal(true);
        dialogAddEdit.setResizable(false);
        dialogAddEdit.setSize(new java.awt.Dimension(360, 425));
        ...
        tfDlgEmail.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tfDlgEmail.setText("jTextField3");
        ...
        pfDlgPassword.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        pfDlgPassword.setText("jPasswordField1");

        pfDlgRetype.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        pfDlgRetype.setText("jPasswordField2");
        ...
        grpDlgGender.add(radDlgMale);
        radDlgMale.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        radDlgMale.setSelected(true);
        radDlgMale.setText("Male");

        grpDlgGender.add(radDlgFemale);
        radDlgFemale.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        radDlgFemale.setText("Female");

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel16.setText("Group");

        cmbDlgGroup.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel11.setText("Name");

        tfDlgNama.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tfDlgNama.setText("jTextField2");
            ...
            .addGroup(dialogAddEditLayout.createSequentialGroup()
                ...
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dialogAddEditLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pfDlgPassword, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(pfDlgRetype, javax.swing.GroupLayout.Alignment.TRAILING)))
                    .addGroup(dialogAddEditLayout.createSequentialGroup()
                    ...
                    .addGroup(dialogAddEditLayout.createSequentialGroup()
                        ...
                        .addGap(96, 96, 96)
                        .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tfDlgNama)
                            .addGroup(dialogAddEditLayout.createSequentialGroup()
                                .addComponent(radDlgMale)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 46, Short.MAX_VALUE)
                                .addComponent(radDlgFemale))
                            .addComponent(tfDlgId)
                            .addComponent(tfDlgEmail, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cmbDlgGroup, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        dialogAddEditLayout.setVerticalGroup(
            ...
            .addGroup(dialogAddEditLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfDlgEmail, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12))
                .addGap(21, 21, 21)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(tfDlgNama, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(radDlgMale)
                    .addComponent(radDlgFemale)
                ...
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbDlgGroup, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel16))
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(pfDlgPassword, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel14))
                .addGap(18, 18, 18)
                .addGroup(dialogAddEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(pfDlgRetype, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13))
                .addGap(18, 18, 18)
        ...
        tblRecord.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "E-mail", "Nama", "Jenis Kelamin", "Group", "Tgl. Daftar", "Login Terakhir"
            }
        ) {
        ...
        if (tblRecord.getColumnModel().getColumnCount() > 0) {
            ...
            tblRecord.getColumnModel().getColumn(4).setMinWidth(60);
            tblRecord.getColumnModel().getColumn(4).setMaxWidth(60);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if( JOptionPane.showConfirmDialog( this, "Are you sure ?", "Delete Record Comfirmation", JOptionPane.YES_NO_OPTION ) == 0 ) {
            doDeleteRecord();
        }
    ...
    private void dialogAddEditWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_dialogAddEditWindowClosing
        // TODO add your handling code here:
        pfDlgPassword.setText( null );
        pfDlgRetype.setText(   null );
    ...
    private void dialogAddEditComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_dialogAddEditComponentShown
        ...
        for( Group grup : groupRecord ) {
            model.addElement( grup.getName() );
        }
        cmbDlgGroup.setModel( model );
        
        if( isEditRecord && getRecordIndexOnTable() >= 0 ) {
            dlgTitle = "Edit Selected Record";
            dlgId    = String.valueOf(modelRecord.get( getRecordIndexOnTable() ).getId() );
            dlgNama  = modelRecord.get( getRecordIndexOnTable() ).getName();
            dlgEmail = modelRecord.get( getRecordIndexOnTable() ).getEmail();
            if( modelRecord.get( getRecordIndexOnTable() ).isFemale() ) {
                radDlgFemale.doClick();
            }
            else {
                radDlgMale.doClick();
            }
            ...
            int iterator = 0;
            for( int groupId : grpNameMap.keySet() ) {
                if( groupId == modelRecord.get( getRecordIndexOnTable() ).getGrup() ) {
                    cmbDlgGroup.setSelectedIndex( iterator );
                    break;
                }
                ++iterator;
            }
        ...
        tfDlgNama.setText(  dlgNama );
        tfDlgEmail.setText( dlgEmail );
        pfDlgPassword.setText( null );
        pfDlgRetype.setText(   null );
    ...
    private void btnDlgConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDlgConfirmActionPerformed
        ...
        if( !Helper.isValidEmailAddress( Helper.nullifyEmpty( tfDlgEmail.getText() ) ) ) {
            JOptionPane.showMessageDialog( this,
        ...
        // name is empty?
        if( Helper.nullifyEmpty( tfDlgNama.getText() ) == null ) {
            JOptionPane.showMessageDialog( this,
                 "Name is empty",
                null, JOptionPane.WARNING_MESSAGE );
        ...
        // Password not match?
        if( !String.valueOf( pfDlgPassword.getPassword() ).equals( String.valueOf( pfDlgRetype.getPassword() ) ) ) {
            JOptionPane.showMessageDialog( this,
        ...
        if( JOptionPane.showConfirmDialog( this, "Are you sure ?", dialogAddEdit.getTitle() + " Comfirmation", JOptionPane.YES_NO_OPTION ) == 0 ) {
            doAddEditRecord();
            dialogAddEdit.dispatchEvent(new WindowEvent( dialogAddEdit, WindowEvent.WINDOW_CLOSING ) );
        }
    ...
    private javax.swing.JComboBox<String> cmbDlgGroup;
    private javax.swing.JDialog dialogAddEdit;
    private javax.swing.ButtonGroup grpDlgGender;
    ...
    private javax.swing.JPasswordField pfDlgPassword;
    private javax.swing.JPasswordField pfDlgRetype;
    private javax.swing.JRadioButton radDlgFemale;
    private javax.swing.JRadioButton radDlgMale;
    private javax.swing.JTable tblRecord;
    private javax.swing.JTextField tfDlgEmail;
    private javax.swing.JTextField tfDlgId;
    private javax.swing.JTextField tfDlgNama;
